...
## Environments
- Preview: https://main--aem-boilerplate-forms-copy--Sakshat17.hlx.page/
- Live: https://main--aem-boilerplate-forms-copy--Sakshat17.hlx.live/
...
1. Open the `aem-boilerplate-forms-copy` directory in your favorite IDE and start coding :)
